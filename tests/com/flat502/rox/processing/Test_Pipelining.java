...
public class Test_Pipelining extends TestCase {
    ...
    public void testHttp10Pipelining() throws Exception {
        String[] request = new String[] { "POST / HTTP/1.0", "Host: name", "Content-Type: text/xml",
                "Content-Length: 185", "", "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>server.toUpper</methodName>", "	<params>", "		<param>",
                "			<value><string>first call</string></value>", "		</param>", "	</params>",
    ...
    public void testHttpPipeliningAsync() throws Exception {
        HttpRequest req1 = constructHttpRequest(new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>server.method</methodName>", "	<params>", "		<param>",
                "			<value><string>first call</string></value>", "		</param>", "	</params>", "</methodCall>" });
        HttpRequest req2 = constructHttpRequest(new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>server.method</methodName>", "	<params>", "		<param>",
                "			<value><string>second call</string></value>", "		</param>", "	</params>", "</methodCall>" });
    ...
    public void testHttpPipeliningSync() throws Exception {
        HttpRequest req1 = constructHttpRequest(new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                ...
                "			<value><int>1000</int></value>", "		</param>", "		<param>",
                "			<value><string>first call</string></value>", "		</param>", "	</params>", "</methodCall>" });
        HttpRequest req2 = constructHttpRequest(new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>server.delay</methodName>", "	<params>", "		<param>",
                "			<value><int>100</int></value>", "		</param>", "		<param>",
                "			<value><string>second call</string></value>", "		</param>", "	</params>", "</methodCall>" });
        ...
        try {
            ...
            RpcResponse rsp1 = new SaxMethodResponseUnmarshaller().unmarshal(Utils.join("",
                    rsp1Lines.toArray(new String[0])));
            ...
            RpcResponse rsp2 = new SaxMethodResponseUnmarshaller().unmarshal(Utils.join("",
                    rsp2Lines.toArray(new String[0])));
    ...
    private class AsyncServerHandler implements AsynchronousRequestHandler {
        ...
        @Override
        public synchronized void handleRequest(Request call, RequestContext context, ResponseChannel rspChannel)
                throws Exception {
            try {
                this.calls.add(call);
