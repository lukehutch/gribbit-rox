...
public abstract class TestBase_MethodResponseUnmarshaller extends TestBase_Unmarshaller {
    ...
    public void testStringValue() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodResponse>", "	<params>", "		<param>",
                "			<value><string>foo</string></value>", "		</param>", "	</params>", "</methodResponse>" };
    ...
    public void testFault() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodResponse>", "	<fault>", "		<value>",
                "			<struct>", "				<member>", "					<name>faultCode</name>", "					<value><int>42</int></value>",
                "				</member>", "				<member>", "					<name>faultString</name>",
                "					<value><string>Life, the Universe and Everything</string></value>", "				</member>",
    ...
    public void testExplicitStringEnumValue() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodResponse>", "	<params>", "		<param>",
                "			<value><string>BAR</string></value>", "		</param>", "	</params>", "</methodResponse>" };
        String xml = toString(xmlLines);
    ...
    public void testImplicitStringEnumValue() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodResponse>", "	<params>", "		<param>",
                "			<value>BAR</value>", "		</param>", "	</params>", "</methodResponse>" };
        String xml = toString(xmlLines);
    ...
    public void testListOfCharsAsString() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodResponse>", "	<params>", "		<param>",
                "			<value>", "				<array>", "					<data>", "						<value>h</value>", "						<value>e</value>",
                "						<value>l</value>", "						<value>l</value>", "						<value>o</value>",
                "						<value>!</value>", "					</data>", "				</array>", "			</value>", "		</param>",
    ...
    public void testTypedList() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodResponse>", "	<params>", "		<param>",
                "			<value>", "				<array>", "					<data>", "						<value>first</value>",
                "						<value>second</value>", "					</data>", "				</array>", "			</value>", "		</param>",
                "	</params>", "</methodResponse>" };
        String xml = toString(xmlLines);
    ...
    public void testTypedListFieldMember() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodResponse>", "	<params>", "		<param>",
                "			<value>", "				<struct>", "					<member>", "						<name>public-list</name>", "						<value>",
                "							<array>", "								<data>", "									<value>first</value>",
                "									<value>second</value>", "								</data>", "							</array>", "						</value>",
    ...
    public void testTypedListMethodMember() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodResponse>", "	<params>", "		<param>",
                "			<value>", "				<struct>", "					<member>", "						<name>private-list</name>", "						<value>",
                "							<array>", "								<data>", "									<value>first</value>",
                "									<value>second</value>", "								</data>", "							</array>", "						</value>",
                "					</member>", "				</struct>", "			</value>", "		</param>", "	</params>", "</methodResponse>" };
        String xml = toString(xmlLines);
    ...
    public void testIncorrectlyTypedListFieldMember() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodResponse>", "	<params>", "		<param>",
                "			<value>", "				<struct>", "					<member>", "						<name>public-list</name>", "						<value>",
                "							<array>", "								<data>", "									<value><int>42</int></value>",
                "									<value><int>43</int></value>", "								</data>", "							</array>", "						</value>",
                "					</member>", "				</struct>", "			</value>", "		</param>", "	</params>", "</methodResponse>" };
        String xml = toString(xmlLines);
    ...
    public void testObjectAsReturnType() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodResponse>", "	<params>", "		<param>",
                "			<value>", "				<struct>", "					<member>", "						<name>foo</name>",
                "						<value>bar</value>", "					</member>", "				</struct>", "			</value>", "		</param>",
                "	</params>", "</methodResponse>" };
        String xml = toString(xmlLines);
    ...
    public void testMismatchedFieldTypeStructToString() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodResponse>", "	<params>", "		<param>",
                "			<value>", "				<struct>", "					<member>", "						<name>string-member</name>", "						<value>",
                "							<struct>", "								<member>", "									<name>key</name>",
                "									<value>value</value>", "								</member>", "							</struct>", "						</value>",
                "					</member>", "				</struct>", "			</value>", "		</param>", "	</params>", "</methodResponse>" };
        String xml = toString(xmlLines);
