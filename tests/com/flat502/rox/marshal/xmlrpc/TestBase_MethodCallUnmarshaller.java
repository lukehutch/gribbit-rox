...
public abstract class TestBase_MethodCallUnmarshaller extends TestBase_Unmarshaller {
    ...
    public void testMethodName() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "</methodCall>" };
    ...
    public void testMalformedXMLRPC() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>server.delay</methodName>", "	<params>", "			<value><int>1000</int></value>",
    ...
    public void testDuplicateMethodName() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>server.delay</methodName>", "	<methodName>server.broken</methodName>", "	<params>",
                "		<param>", "			<value><int>1000</int></value>", "			<value><string>first call</string></value>",
    ...
    public void testDuplicateParam() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                ...
                "			<value><int>1000</int></value>", "			<value><string>first call</string></value>", "		</param>",
                "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testDuplicateStruct() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>key</name><value>value</value>", "					</member>", "				</struct>",
                "				<struct>", "					<member>", "						<name>key</name><value>value</value>", "					</member>",
    ...
    public void testDuplicateArray() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<array>",
                "					<data><value>string value</value></data>", "				</array>", "				<array>",
                "					<data><value>string value</value></data>", "				</array>", "			</value>", "		</param>",
                "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testDuplicateStructNested() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\" encoding=\"UTF-8\"?>", "<methodCall>",
                "   <methodName>testName</methodName>", "   <params>", "      <param>", "         <value>",
                "            <struct>", "               <member>",
                "                  <name>public-second-level</name>", "                  <value>",
                "                     <struct>", "                        <member>",
    ...
    public void testEmptyImplicitStringValueTag() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value />", "		</param>",
                "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testEmptyExplicitStringValueTag() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value><string/></value>",
                "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    private void testEmptyTypedValueTags(String type) throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                ...
                "			<value><" + type + "/></value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testSingleLongLine() throws Exception {
        String[] xmlLines = { "<?xml version=\"1.0\"?>", "<methodCall>", "	<methodName>testMethod</methodName>",
                "	<params>", "		<param>", "			<value>test</value>", "		</param>", "		<param>",
                "			<value>test</value>", "		</param>", "		<param>", "			<value>test</value>", "		</param>",
                "		<param>", "			<value>test</value>", "		</param>", "		<param>", "			<value>test</value>",
                "		</param>", "		<param>", "			<value>test</value>", "		</param>", "		<param>",
                "			<value>test</value>", "		</param>", "		<param>", "			<value>test</value>", "		</param>",
                "		<param>", "			<value>test</value>", "		</param>", "		<param>", "			<value>test</value>",
                "		</param>", "		<param>", "			<value>test</value>", "		</param>", "		<param>",
                "			<value>test</value>", "		</param>", "		<param>", "			<value>test</value>", "		</param>",
                ...
                "		<param>", "			<value>test</value>", "		</param>", "		<param>", "			<value>test</value>",
                "		</param>", "		<param>", "			<value>test</value>", "		</param>", "		<param>",
                "			<value>test</value>", "		</param>", "	</params>" + "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testMultipleParams() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value><int>1</int></value>",
                "		</param>", "		<param>", "			<value><int>2</int></value>", "		</param>", "		<param>",
                "			<value><int>3</int></value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testInvalidParamType() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>",
                "			<value><invalid>42</invalid></value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testIntParam_int() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>",
                "			<value><int>42</int></value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testIntParam_i4() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value><i4>42</i4></value>",
                "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testStringParam_implicit() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>string value</value>",
                "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testStringParam_explicit() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>",
                "			<value><string>string value</string></value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testStringParamEscaped() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>",
                "			<value><string>&lt;div&gt;foo&amp;bar&lt;/div&gt;</string></value>", "		</param>",
                "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testDoubleParam() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>",
                "			<value><double>42.5</double></value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testDateParam() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>",
                "			<value><dateTime.iso8601>19980717T14:08:55</dateTime.iso8601></value>", "		</param>",
                "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testStructParam() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>string member</name>", "						<value>string value</value>",
                "					</member>", "					<member>", "						<name>int member</name>",
                "						<value><int>42</int></value>", "					</member>", "				</struct>", "			</value>",
                "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testStructWithEmptyStructParam() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>empty struct</name>", "						<value><struct></struct></value>",
    ...
    public void testArrayParam() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<array>",
                "					<data>", "						<value>string value</value>", "						<value><int>42</int></value>",
    ...
    public void testTypedArrayField() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>public-typed-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value>", "										<struct>", "											<member>",
                "												<name>string-member</name>", "												<value>hit me baby</value>",
                "											</member>", "										</struct>", "									</value>", "									<value>",
                "										<struct>", "											<member>", "												<name>string-member</name>",
                "												<value>one more time</value>", "											</member>", "										</struct>",
    ...
    public void testTypedArrayMethod() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>private-typed-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value>", "										<struct>", "											<member>",
                "												<name>string-member</name>", "												<value>hit me baby</value>",
                "											</member>", "										</struct>", "									</value>", "									<value>",
                "										<struct>", "											<member>", "												<name>string-member</name>",
    ...
    public void testPrimitiveIntArrayField() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>public-int-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value><int>42</int></value>", "									<value><int>43</int></value>",
    ...
    public void testPrimitiveIntArrayMethod() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>private-int-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value><int>42</int></value>", "									<value><int>43</int></value>",
                "								</data>", "							</array>", "						</value>", "					</member>", "				</struct>",
                "			</value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testPrimitiveDoubleArrayField() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>public-double-array</name>", "						<value>", "							<array>",
    ...
    public void testPrimitiveDoubleArrayMethod() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>private-double-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value><double>3.14</double></value>",
                "									<value><double>6.28</double></value>", "								</data>", "							</array>",
                "						</value>", "					</member>", "				</struct>", "			</value>", "		</param>", "	</params>",
                "</methodCall>" };
    ...
    public void testPrimitiveBooleanArrayField() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>public-boolean-array</name>", "						<value>", "							<array>",
    ...
    public void testPrimitiveBooleanArrayMethod() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>private-boolean-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value><boolean>1</boolean></value>",
                "									<value><boolean>1</boolean></value>", "								</data>", "							</array>",
                "						</value>", "					</member>", "				</struct>", "			</value>", "		</param>", "	</params>",
                "</methodCall>" };
    ...
    public void testIntegerArrayField() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>public-integer-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value><int>42</int></value>", "									<value><int>43</int></value>",
                "								</data>", "							</array>", "						</value>", "					</member>", "				</struct>",
                "			</value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testNestedListField() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>public-list</name>", "						<value>", "							<array>",
                "								<data>", "									<value>", "										<array>", "											<data>",
                "												<value><int>42</int></value>", "												<value><int>43</int></value>",
                "											</data>", "										</array>", "									</value>", "									<value>",
                "										<array>", "											<data>", "												<value><int>44</int></value>",
                "												<value><int>45</int></value>", "												<value><int>46</int></value>",
    ...
    public void testNestedListMethod() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>private-list</name>", "						<value>", "							<array>",
                "								<data>", "									<value>", "										<array>", "											<data>",
                "												<value><int>42</int></value>", "												<value><int>43</int></value>",
                "											</data>", "										</array>", "									</value>", "									<value>",
                "										<array>", "											<data>", "												<value><int>44</int></value>",
    ...
    public void testMapField() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>public-map</name>", "						<value>", "							<struct>",
                "								<member>", "									<name>string member</name>", "									<value>string value</value>",
                "								</member>", "							</struct>", "						</value>", "					</member>", "				</struct>",
                "			</value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testMapMethod() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>private-map</name>", "						<value>", "							<struct>",
                "								<member>", "									<name>string member</name>", "									<value>string value</value>",
                "								</member>", "							</struct>", "						</value>", "					</member>", "				</struct>",
                "			</value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testJaggedCustomTypeArrayField() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>public-custom-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value>", "										<array>", "											<data>",
                "												<value>", "													<struct>", "														<member>",
                "															<name>string-member</name>", "															<value>hit me baby</value>",
                "														</member>", "													</struct>", "												</value>", "												<value>",
                ...
                "													<struct>", "														<member>", "															<name>string-member</name>",
                "															<value>hit me baby</value>", "														</member>", "													</struct>",
                "												</value>", "												<value>", "													<struct>", "														<member>",
                "															<name>string-member</name>", "															<value>one more time</value>",
                "														</member>", "													</struct>", "												</value>", "												<value>",
                "													<struct>", "														<member>", "															<name>string-member</name>",
                "															<value>ooh ooh</value>", "														</member>", "													</struct>",
                "												</value>", "											</data>", "										</array>", "									</value>",
                "								</data>", "							</array>", "						</value>", "					</member>", "				</struct>",
                "			</value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testJaggedCustomTypeArrayMethod() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>private-custom-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value>", "										<array>", "											<data>",
                "												<value>", "													<struct>", "														<member>",
                "															<name>string-member</name>", "															<value>hit me baby</value>",
                "														</member>", "													</struct>", "												</value>", "												<value>",
    ...
    public void testJaggedObjectArrayField() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>public-object-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value>", "										<array>", "											<data>",
                "												<value><string>foo</string></value>", "												<value><int>42</int></value>",
                "											</data>", "										</array>", "									</value>", "									<value>",
                "										<array>", "											<data>", "												<value><double>3.14</double></value>",
                "												<value><boolean>1</boolean></value>", "											</data>", "										</array>",
                "									</value>", "								</data>", "							</array>", "						</value>", "					</member>",
                "				</struct>", "			</value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testJaggedObjectArrayMethod() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>private-object-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value>", "										<array>", "											<data>",
                "												<value><string>foo</string></value>", "												<value><int>42</int></value>",
                "											</data>", "										</array>", "									</value>", "									<value>",
                "										<array>", "											<data>", "												<value><double>3.14</double></value>",
    ...
    public void testStructParamMethod() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>string-object</name>", "						<value>string object</value>",
                "					</member>", "					<member>", "						<name>char-array</name>",
                "						<value>char array</value>", "					</member>", "					<member>",
                "						<name>int-object</name>", "						<value><int>42</int></value>", "					</member>",
                "					<member>", "						<name>int-val</name>", "						<value><int>24</int></value>",
                "					</member>", "					<member>", "						<name>double-object</name>",
                "						<value><double>3.14</double></value>", "					</member>", "					<member>",
                "						<name>double-val</name>", "						<value><double>6.28</double></value>", "					</member>",
                "					<member>", "						<name>float-object</name>", "						<value><double>3.24</double></value>",
                "					</member>", "					<member>", "						<name>float-val</name>",
                "						<value><double>6.48</double></value>", "					</member>", "					<member>",
                "						<name>boolean-val</name>", "						<value><boolean>1</boolean></value>", "					</member>",
                "					<member>", "						<name>boolean-object</name>", "						<value><boolean>1</boolean></value>",
                "					</member>", "					<member>", "						<name>date</name>",
                "						<value><dateTime.iso8601>19980717T14:08:55</dateTime.iso8601></value>", "					</member>",
                "				</struct>", "			</value>", "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testStructParamField() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                ...
                "					</member>", "					<member>", "						<name>date</name>",
                "						<value><dateTime.iso8601>19980717T14:08:55</dateTime.iso8601></value>", "					</member>",
                "					<member>", "						<name>object-array</name>", "						<value>", "							<array>",
                "								<data>", "									<value>", "										<string>ObjectOne</string>", "									</value>",
                "									<value>", "										<string>ObjectTwo</string>", "									</value>", "								</data>",
                "							</array>", "						</value>", "					</member>", "				</struct>", "			</value>",
                "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public void testStructParamNested() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\" encoding=\"UTF-8\"?>", "<methodCall>",
                ...
                "                        </member>", "                     </struct>",
                "                  </value>", "               </member>", "               <member>",
                "                  <name>private-second-level</name>", "                  <value>",
                "                     <struct>", "                        <member>",
                "                           <name>name</name>", "                           <value>",
    ...
    public void testFailOnMissingFieldWithSetterMethod() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>testMethod</methodName>", "	<params>", "		<param>", "			<value>", "				<struct>",
                "					<member>", "						<name>string-object</name>", "						<value>string object</value>",
                "					</member>", "					<member>", "						<name>missing-field</name>",
                "						<value>missing field value</value>", "					</member>", "				</struct>", "			</value>",
                "		</param>", "	</params>", "</methodCall>" };
        String xml = toString(xmlLines);
    ...
    public static class Testes {
        ...
        public String toString() {
            return "Testes: " + i + ", " + b + ", " + d + ", \"" + s + "\", \"" + s2 + "\", " + o1 + ", " + o2
                    + ", " + o3 + ", " + o4 + ", " + o5 + ", " + o6 + ", " + Utils.toString(ai) + ", "
                    + Utils.toString(aab) + ", " + Utils.toString(oi) + ", (" + innerTestes + "), "
                    + Utils.toString(innerTestesArray);
        }
    }
    ...
    public static class Testes2 {
        ...
        @Override
        public String toString() {
            return "Testes2: " + i + ", " + b + ", " + d + ", " + intValue + ", " + booleanValue + ", "
                    + doubleValue;
        }
    }
    ...
    public void testReservation() throws Exception {
        String[] xmlLines = new String[] { "<?xml version=\"1.0\"?>", "<methodCall>",
                ...
                "								<member>", "									<name>foo</name>", "									<value>1234</value>",
                "								</member>", "							</struct>", "						</value>", "					</member>", "					<member>",
                "						<name>id</name>", "						<value>string object</value>", "					</member>", "					<member>",
                "						<name>kill</name>", "						<value><boolean>1</boolean></value>", "					</member>",
