...
public class Test_Base64Codec extends TestBase_XmlRpcMethod {
    ...
    public void testDecodeArraySubset() throws Exception {
        char[] input = "<?xml version=\"1.0\"?><methodCall>	<methodName>testMethod</methodName>	<params>		<param>			<value><base64>eW91IGNhbid0IHJlYWQgdGhpcyE=</base64></value>		</param>	</params></methodCall>"
                .toCharArray();
