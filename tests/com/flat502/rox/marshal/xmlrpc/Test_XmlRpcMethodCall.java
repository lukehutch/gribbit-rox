...
public class Test_XmlRpcMethodCall extends TestBase_XmlRpcMethod {
    ...
    public void testTypedStructParamNested() throws Exception {
        ...
        assertXpathEvaluatesTo("name", "/methodCall/params/param/value/struct/member[2]/value/struct/member/name",
                xml);
    ...
    public void testTypedTypedArrayFields() throws Exception {
        ...
        assertXpathEvaluatesTo(
                "private member",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value/struct/member/value/string",
                xml);
        assertXpathEvaluatesTo("string-member",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value/struct/member/name", xml);
        assertXpathEvaluatesTo(
                "public member",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value/struct/member/value/string",
                xml);
    }
    ...
    public void testTypedPrimitiveArray() throws Exception {
        PrimitiveArraysStruct struct = new PrimitiveArraysStruct(new int[] { 42, 43 }, new int[] { 44, 45 },
                new boolean[] { true, false }, new boolean[] { false, true }, new double[] { 3.14, 6.28 },
                new double[] { 4.14, 5.28 });
        XmlRpcMethodCall call = new XmlRpcMethodCall("testName", new Object[] { struct });
        String xml = new String(call.marshal(), "UTF-8");

        assertXpathEvaluatesTo("testName", "/methodCall/methodName", xml);
        assertXpathEvaluatesTo("0",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[1]/boolean", xml);
        assertXpathEvaluatesTo("1",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[2]/boolean", xml);
        ...
        assertXpathEvaluatesTo("44",
                "/methodCall/params/param/value/struct/member[3]/value/array/data/value[1]/int", xml);
        assertXpathEvaluatesTo("45",
                "/methodCall/params/param/value/struct/member[3]/value/array/data/value[2]/int", xml);

        assertXpathEvaluatesTo("public-boolean-array", "/methodCall/params/param/value/struct/member[4]/name", xml);
        assertXpathEvaluatesTo("1",
                "/methodCall/params/param/value/struct/member[4]/value/array/data/value[1]/boolean", xml);
        assertXpathEvaluatesTo("0",
                "/methodCall/params/param/value/struct/member[4]/value/array/data/value[2]/boolean", xml);
        ...
        assertXpathEvaluatesTo("42",
                "/methodCall/params/param/value/struct/member[6]/value/array/data/value[1]/int", xml);
        assertXpathEvaluatesTo("43",
                "/methodCall/params/param/value/struct/member[6]/value/array/data/value[2]/int", xml);
    }
    ...
    public void testTypedIntegerArray() throws Exception {
        ...
        assertXpathEvaluatesTo("44",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[1]/int", xml);
        assertXpathEvaluatesTo("45",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[2]/int", xml);
        assertXpathEvaluatesTo("public-integer-array", "/methodCall/params/param/value/struct/member[2]/name", xml);
        assertXpathEvaluatesTo("42",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value[1]/int", xml);
        assertXpathEvaluatesTo("43",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value[2]/int", xml);
    }
    ...
    public void testTypedJaggedIntArray() throws Exception {
        ...
        assertXpathEvaluatesTo(
                "52",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[1]/array/data/value[1]/int",
                xml);
        assertXpathEvaluatesTo(
                "53",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[1]/array/data/value[2]/int",
                xml);
        assertXpathEvaluatesTo(
                "54",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[2]/array/data/value[1]/int",
                xml);
        assertXpathEvaluatesTo(
                "55",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[2]/array/data/value[2]/int",
                xml);
        assertXpathEvaluatesTo(
                "56",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[2]/array/data/value[3]/int",
                xml);

        assertXpathEvaluatesTo("public-int-array", "/methodCall/params/param/value/struct/member[2]/name", xml);
        assertXpathEvaluatesTo(
                "42",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value[1]/array/data/value[1]/int",
                xml);
        assertXpathEvaluatesTo(
                "43",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value[1]/array/data/value[2]/int",
                xml);
        assertXpathEvaluatesTo(
                "44",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value[2]/array/data/value[1]/int",
                xml);
        assertXpathEvaluatesTo(
                "45",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value[2]/array/data/value[2]/int",
                xml);
        assertXpathEvaluatesTo(
                "46",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value[2]/array/data/value[3]/int",
                xml);
    }
    ...
    public void testTypedJaggedCustomTypeArray() throws Exception {
        ...
        pub[1] = new SimpleStruct[] { new SimpleStruct("forty four"), new SimpleStruct("forty five"),
        ...
        priv[1] = new SimpleStruct[] { new SimpleStruct("fifty four"), new SimpleStruct("fifty five"),
    ...
    public void testTypedJaggedObjectArray() throws Exception {
        ...
        assertXpathEvaluatesTo(
                "foo",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[1]/array/data/value[1]/string",
                xml);
        assertXpathEvaluatesTo(
                "42",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[1]/array/data/value[2]/int",
        ...
        assertXpathEvaluatesTo(
                "3.14",
                "/methodCall/params/param/value/struct/member[1]/value/array/data/value[2]/array/data/value[1]/double",
                xml);
        assertXpathEvaluatesTo(
                "1",
        ...
        assertXpathEvaluatesTo(
                "foo",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value[1]/array/data/value[1]/string",
                xml);
        assertXpathEvaluatesTo(
                "42",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value[1]/array/data/value[2]/int",
        ...
        assertXpathEvaluatesTo(
                "3.14",
                "/methodCall/params/param/value/struct/member[2]/value/array/data/value[2]/array/data/value[1]/double",
                xml);
        assertXpathEvaluatesTo(
                "1",
