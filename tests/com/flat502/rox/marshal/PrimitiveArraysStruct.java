...
public class PrimitiveArraysStruct {
    ...
    public PrimitiveArraysStruct(int[] publicIntArray, int[] privateIntArray, boolean[] publicBooleanArray,
            boolean[] privateBooleanArray, double[] publicDoubleArray, double[] privateDoubleArray) {
