...
public class Test_ServerMiscellaneous extends TestCase {
    ...
    public void testHttp11ClientIsDisconnectedAfterIdleTimeout() throws Exception {
        String[] request = new String[] { "POST / HTTP/1.1", "Host: foo", "Content-Type: text/xml",
                "Content-Length: 188", "", "<?xml version=\"1.0\"?>", "<methodCall>",
                "	<methodName>server.toUpper</methodName>", "	<params>", "		<param>",
                "			<value><string>hello world</string></value>", "		</param>", "	</params>", "</methodCall>" };
