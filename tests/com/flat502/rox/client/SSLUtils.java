...
public class SSLUtils {
    ...
    public static X509Certificate loadTrustedEntity(Properties props, String alias) throws Exception {
        ...
        ks.load(new FileInputStream(props.getProperty("javax.net.ssl.trustStore")),
                props.getProperty("javax.net.ssl.trustStorePassword").toCharArray());
    ...
    public static void main(String[] args) {
        System.setProperty("javax.net.ssl.trustStore", "src/com/flat502/rox/test/amazon-combined.truststore");
        System.setProperty("javax.net.ssl.trustStorePassword", "ipmanager");

        System.setProperty("javax.net.ssl.keyStore", "src/com/flat502/rox/test/keystore.p12");
