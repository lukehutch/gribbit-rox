...
public class Test_HttpResponseBuffer extends XMLTestCase {
    public void testSimpleMessage() throws Exception {
        String[] msg = new String[] { "HTTP/1.1 200 OK", "Host: hostname", "Content-Type: text/xml",
    ...
    public void testErrorResponse() throws Exception {
        String[] msg = new String[] { "HTTP/1.1 404 Not Found", "Host: hostname", "Content-Type: text/xml",
                "Content-Length: 5", "", "Hello" };
        HttpResponseBuffer httpRsp = this.newHttpResponseBuffer(msg);
        assertTrue(httpRsp.isComplete());
    ...
    public void testUnsupportedHttpVersion() throws Exception {
        String[] msg = new String[] { "HTTP/0.9 200 OK", "Host: hostname", "Content-Type: text/xml",
                "Content-Length: 5", "", "Hello" };
        try {
            HttpResponseBuffer httpRsp = this.newHttpResponseBuffer(msg);
            httpRsp.isComplete();
    ...
    public void testNoHostVersion11() throws Exception {
        String[] msg = new String[] { "HTTP/1.1 200 OK", "Content-Length: 5", "Content-Type: text/xml", "", "Hello" };
        HttpResponseBuffer httpRsp = this.newHttpResponseBuffer(msg);
        assertTrue(httpRsp.isComplete());
        assertEquals(200, httpRsp.getStatusCode());
        assertEquals("text/xml", httpRsp.getHeaderValue("Content-Type"));
    ...
    public void testNoHostVersion10() throws Exception {
        String[] msg = new String[] { "HTTP/1.0 200 OK", "Content-Length: 5", "", "Hello" };
        HttpResponseBuffer httpRsp = this.newHttpResponseBuffer(msg);
        try {
            httpRsp.isComplete();
    ...
    public void testNoContentType() throws Exception {
        String[] msg = new String[] { "HTTP/1.1 200 OK", "Host: hostname", "Content-Length: 5", "", "Hello" };
        HttpResponseBuffer httpRsp = this.newHttpResponseBuffer(msg);
        assertTrue(httpRsp.isComplete());
    }

    public void testNoContentLength() throws Exception {
        String[] msg = new String[] { "HTTP/1.1 200 OK", "Host: hostname", "Content-Type: text/xml", "", "Hello" };
        try {
            HttpResponseBuffer httpRsp = this.newHttpResponseBuffer(msg);
            httpRsp.isComplete();
            fail();
    ...
    public void testContentTypeCharSet() throws Exception {
        String[] msg = new String[] { "HTTP/1.1 200 OK", "Host: hostname", "Content-Type: text/xml; charset=ASCII",
                "Content-Length: 5", "", "Hello" };
        HttpResponseBuffer httpRsp = this.newHttpResponseBuffer(msg);
        assertTrue(httpRsp.isComplete());
    ...
    private HttpResponseBuffer newHttpResponseBuffer(String[] msg) throws Exception {
        return this.newHttpResponseBuffer(msg, "UTF-8");
    }

    private HttpResponseBuffer newHttpResponseBuffer(String[] msg, String charSet) throws Exception {
