...
/**
 * This class represents an abstract HTTP message and provides support for various aspects of an HTTP message common
 * to both requests and responses.
 * <P>
 * This class is not thread-safe.
 */
public abstract class HttpMessage {
    private static final DateFormatThreadLocal HTTP_DATE_FORMATS = new DateFormatThreadLocal(new SimpleDateFormat(
    ...
    /**
     * Formats a {@link Date} instance as described in <a
     * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.3.1">section 3.1.1</a> of RFC 2616.
     * <p>
     ...
     * @param value
     *            The header value.
     * @return The previous value of the indicated header or <code>null</code> if no value was set.
     ...
     * <p>
     * Header order is preserved. Headers are {@link #marshal(OutputStream) marshalled} in the order in which they
     * are added to this instance, with one exception: duplicate headers.
     * <p>
     * If this method is called multiple times for the same header values are folded into a single comma-separated
     * value as allowed for by <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec4.html#sec4.2">section 4</a>
     * of RFC 2616.
     * <p>
     * Header names are {@link #normalizeHeaderName(String) normalized} before being stored. As such, case is
     * unimportant.
     * <p>
     ...
     * @param value
     *            The header value.
     * @return The new header value (including previous values if the header already existed).
     ...
     * <p>
     * This implementation writes the string returned by {@link #getStartLine()} followed by a newline marker.
     * <p>
     ...
     * <p>
     * If the <code>Content-Type</code> header has not yet been set it is set to 0 (but see
     * {@link #setContent(byte[])} as well).
     * <p>
