...
/**
 * This class provides a pipelined implementation of the core functionality of Java 1.5's <code>BlockingQueue</code>
 * interface.
 * <p>
 * Elements are enqueued along with the "origin". Pipelining happens within the context of each origin. Simply put,
 * a thread calling {@link #take()} will never dequeue an item that shares an origin with another item that was
 * dequeued by a second thread that has not returned to the queue.
 */
