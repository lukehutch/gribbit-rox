 ...
 * <p>
 * When a thread calls the {@link #capture()} method it is blocked until {@link #release()} is invoked. Threads are
 * guaranteed to be released in the order in which they were captured.
 * <p>
 * This class is used to ensure fairness when sharing finite resources across multiple threads.
 */
public class ThreadQueue {
    private List<Thread> captureQueue = new LinkedList<>();
    private Set<Thread> pendingRelease = new HashSet<>();
