 ...
 * <p>
 * This heap implementation is keyed on long values. It provides O(log n) inserts, O(C) remove minumum element, O(N)
 * remove arbitary element.
 * <p>
 * This implementation is unsynchronized. Concurrent access from multiple threads should be controlled by the
 * caller.
 */
public class MinHeap {
    ...
    /**
     * @return <code>true</code> if the heap is empty, <code>false</code> if not.
     */
    ...
    /**
     * This method makes use of the <code>equals()</code> method to locate entries in the heap that are to be
     * removed.
     * <P>
    ...
    /**
     * Reorders the heap so that the indicated index is at the left most position open in the bottom row of the
     * tree.
     */
