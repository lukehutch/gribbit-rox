 ...
 * method. When a response is available it may be sent using this class. This makes it possible to hand work off to
 * application threads, leaving the calling thread to return to the task of handling HTTP responses.
 */
public interface ResponseChannel {
     ...
     * @throws IOException
     *             An exception may be raised while attempting to send the response to the client.
