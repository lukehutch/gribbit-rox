...
public class Level {
    ...
    /**
     * A convenience method that converts a string name into a {@link Level} instance.
     * <p>
     ...
     * @return An appropriate {@link Level} instance, or the default value provided if the level is not supported.
     */
