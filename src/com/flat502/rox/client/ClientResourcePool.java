...
public class ClientResourcePool extends ResourcePool {
     ...
     * pool.
     * <p>
     * If a non-zero limit is configured, any thread requesting a new connection that would cause this limit to be
     * exceeded will be blocked until an existing connection is returned or until a timeout occurs (if a timeout
        ...
        synchronized (this.notifierMutex) {
            if (this.connPool != null) {
                ...
                throw new IllegalStateException(
                        "Connection pool attributes must be configured before executing methods");
            }
        }
     ...
     * <p>
     * All {@link HttpClient} instances sharing a resource pool "inherit" this timeout as their initial timeout
     * value.
     * 
     * @param timeout
