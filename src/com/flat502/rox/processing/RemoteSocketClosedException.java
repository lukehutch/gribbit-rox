 ...
 * <p>
 * This is intended to make it possible to differentiate between the remote entity closing the connection as a
 * result of an error (or abnormal termination) and closing the connection cleanly (typically to limit the number of
 * active connections).
 */
